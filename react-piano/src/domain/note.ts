// sound, note generation. note notation, real kayboard layout
...
// Record <K, T> constructs a type with a set of properties K of type T. utility type
...
// produce a note object from a given midivalue
...
export const notes = generateNotes(); // use given default values to create
